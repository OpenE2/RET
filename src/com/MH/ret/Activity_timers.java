...
public class Activity_timers extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_activity_timers);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	    ...
	    inflater.inflate(R.menu.activity_timers, menu);
	...
	public class getRecStatus extends AsyncTask<String, Void, Integer>{	
		...
		protected void onPreExecute (){
			progressDialog = ProgressDialog.show(Activity_timers.this, "", "Checking Settings and Connectivity!");
		}
		@Override
	...
	public void dialogNotConnected(int failure){
		...
		if(dialogTitleText != null){
			AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Activity_timers.this);
			if(failure == 9){
				alertDialogBuilder
		    	...
		    	.setPositiveButton(R.string.dialog_yes,new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog,int id) {
						Intent intent = new Intent(Activity_timers.this, Activity_settings.class);
